  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <motion.nav
        ...
        className="sticky top-0 z-50 border-b border-border/60 bg-background/88 backdrop-blur-md"
      >
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link href="/login">
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Button size="sm" className="gap-1.5 bg-amber-700 text-white hover:bg-amber-800">
      ...
      <section ref={heroRef} className="relative overflow-hidden py-20 md:py-32">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary/8 via-background to-amber-700/8" />
        <div
        ...
        />
        <motion.div
          className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-amber-700/10 blur-3xl"
          animate={{ y: [0, -20, 0], scale: [1, 1.1, 1] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-primary/8 blur-3xl"
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="relative max-w-6xl mx-auto px-4 sm:px-6">
          <div className="mx-auto max-w-4xl text-center">
            <motion.div custom={0} variants={fadeUp} initial="hidden" animate="visible">
              <Badge variant="secondary" className="mb-6 gap-1.5 border border-primary/15 bg-white/85 px-3 py-1.5 text-xs font-semibold text-primary shadow-sm">
                <Star className="h-3 w-3 fill-amber-600 text-amber-600" />
                Trusted AI legal drafting for India
              </Badge>
            </motion.div>
            ...
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-4xl font-bold leading-[1.02] tracking-tight sm:text-5xl md:text-6xl lg:text-7xl"
            >
              Draft legal documents that look serious, read clearly, and feel ready to use.
              <span className="block bg-gradient-to-r from-primary via-primary to-amber-700 bg-clip-text text-transparent">
                Built for Indian paperwork, not generic templates.
              </span>
            </motion.h1>
            ...
            >
              Create rental agreements, NDAs, legal notices, and more in minutes. Search Indian case law, review contracts, and get AI guidance in plain language across mobile, tablet, and desktop.
            </motion.p>
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="mt-8 flex flex-wrap justify-center gap-3 text-left text-xs text-muted-foreground md:gap-4"
            >
              {[
                { icon: Zap, label: "No legal jargon" },
                { icon: Globe, label: "Built for Indian states" },
                { icon: Clock, label: "Ready in under a minute" },
                { icon: Shield, label: "Structured, reviewable drafts" },
              ].map((item) => (
                <span key={item.label} className="flex items-center gap-1.5 rounded-full border border-border/80 bg-white/80 px-3 py-2 shadow-sm">
            ...
            {FEATURES.map((f) => (
              <motion.div key={f.title} variants={staggerItem}>
                <Card className="h-full group hover:shadow-xl hover:border-primary/20 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/4 to-amber-700/5 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
      ...
      {/* ─── Final CTA ─── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/8 via-background to-amber-700/8 py-24 md:py-32">
        <motion.div
        ...
        />
        <motion.div
          className="absolute -bottom-20 -right-20 h-72 w-72 rounded-full bg-amber-700/10 blur-3xl"
